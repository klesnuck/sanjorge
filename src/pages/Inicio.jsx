    ...
    <section className="w-full">
      ...
      <div className="w-full bg-gray-100 py-8">
        <div className="w-[90%] sm:w-[80%] max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-4 md:p-6 rounded-lg shadow-sm md:shadow-md text-center">
            <div className="w-16 h-16 mx-auto flex items-center justify-center bg-blue-50 rounded-full text-blue-600 mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 13l2-2m0 0l7-7 7 7M13 3v10a1 1 0 001 1h3m-4 6h6" />
              </svg>
            </div>
      ...
      <div className="w-full max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 mt-10 px-4">
        ...
        <div className="flex flex-col justify-center items-center text-center">
          <p className="text-gray-700 max-w-md mb-6 mt-4">
            En nuestro taller ofrecemos servicios de mantenimiento, diagnóstico y reparación automotriz con los más altos estándares de calidad.
          </p>
